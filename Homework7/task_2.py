...
class PersonInfo:
    def __init__(self, full_name: str, age: int, *subdivision):
        self.full_name = full_name
        self.age = age
        self.subdivision = subdivision

    def short_name(self):
        name, lastname = self.full_name.split(' ')
        return f'{lastname} {name[0]}.'
    ...
    def new_salary(self):
        sum_letters = 0
        letters = Counter(''.join(self.subdivision))
        most_common_letters = letters.most_common(3)

        for l, n in most_common_letters:
            sum_letters += n

        return  self.age * 1337 * sum_letters
